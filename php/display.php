...
<body>
    <?php
        ...
        $search = $_POST['search'];
        if(!empty($search)){
            $query = "SELECT * FROM user WHERE email LIKE '%".$search."%' or firstName LIKE '%".$search."%' or 
                        lastName LIKE '%".$search."%' or familyName LIKE '%".$search."%'";
            ...
            echo"Error getting the search word";
        }
    ?>
</body>
</html>    
